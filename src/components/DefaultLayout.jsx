...
const forgotPasswordUrl = '/V3_OUTRIBD_iOAUTH_markedxMONITOR/forgot-password';
const pinVerificationUrl = '/V3_OUTRIBD_iOAUTH_markedxMONITOR/verify-pin';
  ...
  return (
    <section className=''>
      <Modal
        ...
        className="flex justify-center my-10 w-full max-w-md mx-auto"
      >
        <div className="flex flex-col justify-center items-center shadow-lg shadow-slate-500 w-full rounded-xl bg-slate-200 p-4">
          <h2 className='underline'>Verify Email</h2>
          <form onSubmit={handleVerifyPin} className='flex flex-col justify-center w-full'>
            ...
            <div className='flex justify-between my-4'>
              <button type="submit" className='bg-slate-500 hover:bg-orange-500 opacity-75 px-4 py-2 transform duration-300 ease-in-out rounded-lg'>
                {isVerifyingPin ? (
              ...
              <button type="button" className='bg-slate-500 hover:bg-orange-500 opacity-75 px-4 py-2 transform duration-300 ease-in-out rounded-lg' onClick={() => setIsVerifyModalOpen(false)}>Cancel</button>
            </div>
          </form>
        </div>
      </Modal>
      ...
      >
        <div className="flex flex-col justify-center items-center shadow-lg shadow-slate-500 w-full rounded-xl bg-slate-200 p-4">
          ...
          <form onSubmit={handlePasswordChange} className='flex flex-col justify-center w-full'>
            <label className='flex flex-col'>
              Password:
              <input
                type="password"
            ...
            <div className='flex justify-between my-4'>
              ...
              <button type="button" className='bg-slate-500 hover:bg-orange-500 opacity-75 px-4 py-2 transform duration-300 ease-in-out rounded-lg' onClick={handleCloseModal}>Cancel</button>
            </div>
          </form>
        </div>
      </Modal>
        ...
        <div className={`flex justify-between items-center shadow-sm shadow-slate-500 py-3 sm:px-2`}>
          ...
          <div className=''>
            ...
            <ul className='flex justify-center items-center space-x-4 capitalize'>
              ...
              <li><Link to={"/default/alltransactions"} className={`${location.pathname === "/default/alltransactions" || location.pathname === "/default/alltransactions/billhistory" || location.pathname === "/default/alltransactions/wallethistory" ? "bg-blue-950 opacity-75 text-slate-300 rounded-md px-3 py-1" : "hover:bg-blue-950 opacity-75 transform duration-300 ease-in-out rounded-md px-3 py-1 hover:text-slate-300"}`}>transactions</Link></li>
      ...
      <div className='relative sm:hidden'>
          <div className='flex justify-between py-2 px-1 border-b-2 border-slate-500'>
            <Link to={"/"}>
                <img
                    src={Black_Logo}
                    alt={'logo'}
            ...
            <div className='flex flex-col justify-normal items-center space-x-4 capitalize'>
                <div className='flex justify-normal items-center mt-[10px]'>
        ...
        <div className='sm:shadow-sm sm:shadow-slate-500 w-1/4 py-4 flex sm:flex-col sm:justify-between'>
          <ul className='flex flex-col justify-normal items-center space-y-8'>
            ...
            <li><Link to={"/default/alltransactions"} className={`${location.pathname === "/default/alltransactions" || location.pathname === "/default/alltransactions/billhistory" ? "bg-blue-950 opacity-75 rounded-md px-3 py-2" : " "}`}><Transaction /></Link></li>
            <li><Link to={"/default/profile"} className={`${location.pathname === "/default/profile" ? "bg-blue-950 opacity-75 rounded-md px-3 py-2" : " "}`}><DocumentUser /></Link></li>
            <li><Link to={"/default/faq"} className={`${location.pathname === "/default/faq" ? "bg-blue-950 opacity-75 rounded-md px-3 py-2" : " "}`}><CircleQuestion /></Link></li>
            <li><Link to={"/default/contactus"} className={`${location.pathname === "/default/contactus" ? "bg-blue-950 opacity-75 rounded-md px-3 py-2" : " "}`}><Contact /></Link></li>
          </ul>
        </div>
        <Outlet />
        </div>
