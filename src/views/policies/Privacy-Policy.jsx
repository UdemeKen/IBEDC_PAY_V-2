...
export default function PrivacyPolicy() {
  return (
    <section className='flex flex-col justify-center items-center text-center w-full max-w-full sm:text-justify sm:my-8'>
        <div className='flex flex-col justify-center items-center gap-6 shadow-sm shadow-slate-500 rounded-lg sm:w-3/4 sm:p-8'>
            <div className='text-center font-bold text-[25px] text-orange-500'>
                <h2 className='underline'>Privacy Policy for IBEDCPAY</h2>
            </div>
            <div>
                <h4 className='font-semibold text-[18px]'>Privacy Policy</h4>
                <p>
                    ...
                    We use your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created for IBEDC.
                </p>
                <h4 className='font-semibold text-[18px]'>Interpretation and Definitions</h4>
                <h4 className='font-semibold text-[18px]'>Interpretation</h4>
                <p>
                    The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
                </p>
                <h4 className='font-semibold text-[18px]'>Definitions</h4>
                ...
                <ul className='list-disc pl-6'>
                    ...
                    <li>Application means the software program provided by the Company downloaded by You on any electronic device, named IBEDCPAY.</li>
                    <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to IBEDC, Capital Building, 115 MKO Abiola Way (Ring Road) Ibadan, Oyo State.</li>
                    ...
                    <li>Website refers to IBEDCPAY, accessible from <Link to='https://pay.ibedc.com/' className='text-blue-600 hover:underline' target='_blank'>Pay.ibedc.com</Link></li>
                    <li>You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
               <h4 className='font-semibold text-[18px]'>Collecting and Using Your Personal Data</h4>
                <h4 className='font-semibold text-[18px] my-2'>Types of Data Collected</h4>
                <h4 className='font-semibold text-[18px]'>Personal Data</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Usage Data</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Information Collected while Using the Application</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Tracking Technologies and Cookies</h4>
                <p>
                ...
                <ul className='list-disc pl-6'>
                    ...
                    <li>Flash Cookies. Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how You can delete Flash Cookies, please read "Where can I change the settings for disabling, or deleting local shared objects?" available <Link to='https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_' className='text-blue-600 hover:underline' target='_blank'>here</Link></li>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Type: Session Cookies</h4>
                <h4 className='font-semibold text-[18px] mt-2'>Administered by: Us</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Type: Persistent Cookies</h4>
                <h4 className='font-semibold text-[18px] mt-2'>Administered by: Us</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Use of Your Personal Data</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Retention of Your Personal Data</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Transfer of Your Personal Data</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Disclosure of Your Personal Data</h4>
                <h4 className='font-semibold text-[18px] mt-2'>Business Transactions</h4>
                <p>
                    If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                </p>
                <h4 className='font-semibold text-[18px] mt-2'>Law enforcement</h4>
                <p>
                    Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                </p>
                <h4 className='font-semibold text-[18px] mt-2'>Other legal requirements</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Security of Your Personal Data</h4>
                <p>
                    The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.
                </p>
                <h4 className='font-semibold text-[18px] mt-2'>Children's Privacy</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Links to Other Websites</h4>
                <p>
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Changes to this Privacy Policy</h4>
                <p>
                    This Privacy and Cookies Policy is intended to meet our obligations under the “Nigeria Data Protection Act” 2023 or NDPA, a legal framework that sets guidelines for the protection and processing of personal information of individuals within Nigeria or residing outside Nigeria but of Nigerian descent.<br />
                ...
                <h4 className='font-semibold text-[18px] mt-2'>Contact Us</h4>
                <p>
                    If you have any questions about this Privacy Policy, You can contact us:
                </p>
                <ul className='list-disc pl-6'>
                    <li>By email: info@ibedc.com</li>
                    <li>By visiting this page on our website:  <Link to='https://ibedc.com/contact' className='text-blue-600 hover:underline' target='_blank'>https://ibedc.com/contact</Link></li>
                    <li>By phone number: +2347001239999</li>
                </ul>
            </div>
        </div>
    </section>
