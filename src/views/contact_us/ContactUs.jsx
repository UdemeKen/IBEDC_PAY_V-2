...
export default function ContactUs() {
  ...
  return (
    <section className='flex justify-center w-full h-full mx-2 sm:mx-0'>
        ...
        >
          <div>
            ...
            <button
              ...
              className={`bg-slate-600 opacity-75 rounded-lg text-white hover:bg-orange-500 transform duration-300 ease-in-out mx-10 py-1 cursor-pointer`}>
              {!loading && <p>Submit</p>}
              {loading && 
          ...
          <div className='flex flex-col justify-center items-center mt-5 '>
            <p className='text-slate-600 text-center'>For more information, please contact us on:</p>
