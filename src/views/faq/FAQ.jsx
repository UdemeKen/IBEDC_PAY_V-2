...
export default function FAQ() {
  ...
  console.log(heroVariants.hero_01Variants);
      ...
      <div className='shadow-sm shadow-slate-500 sm:my-10 sm:w-1/2 flex flex-col sm:justify-center sm:items-center py-5 rounded-lg'>
        <div className='sm:w-3/4 px-2'>
          <motion.div 
            ...
            initial='hidden'
            animate='visible'
          className='shadow-sm shadow-slate-500 bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 rounded-t-md cursor-pointer' onClick={handleToggler}>
          ...
          <motion.div 
            variants={heroVariants.hero_02Variants}
            initial='hidden'
            animate='visible'
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 cursor-pointer' onClick={handleToggler_2}>
            <p className='text-slate-700 opacity-85'>.</p>
          ...
          <motion.div 
            variants={heroVariants.hero_03Variants}
            initial='hidden'
            animate='visible'
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 cursor-pointer' onClick={handleToggler_3}>
            <p className='text-slate-700 opacity-85'>.</p>
          ...
          <motion.div
            variants={heroVariants.hero_04Variants}
            initial='hidden'
            animate='visible' 
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 cursor-pointer' onClick={handleToggler_4}>
            <p className='text-slate-700 opacity-85'>.</p>
          ...
          <motion.div 
            variants={heroVariants.hero_05Variants}
            initial='hidden'
            animate='visible'
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 cursor-pointer' onClick={handleToggler_5}>
            <p className='text-slate-700 opacity-85'>.</p>
          ...
          <motion.div 
            variants={heroVariants.hero_06Variants}
            initial='hidden'
            animate='visible'
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 cursor-pointer' onClick={handleToggler_6}>
            <p className='text-slate-700 opacity-85'>.</p>
          ...
          <motion.div
            variants={heroVariants.hero_07Variants}
            initial='hidden'
            animate='visible' 
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 cursor-pointer' onClick={handleToggler_7}>
            <p className='text-slate-700 opacity-85'>.</p>
          ...
          <motion.div 
            variants={heroVariants.hero_08Variants}
            initial='hidden'
            animate='visible'
          className='shadow-sm shadow-slate-500  bg-slate-700 hover:bg-orange-500 transform duration-300 ease-in-out opacity-85 text-center flex justify-between px-5 py-2 rounded-b-md cursor-pointer' onClick={handleToggler_8}>
            <p className='text-slate-700 opacity-85'>.</p>
